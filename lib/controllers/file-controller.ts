...
export class FileController extends EngineController
{
    constructor(server: modepress.IServer, config: modepress.IConfig, e: express.Express)
    {
        ...
        modepress.EventManager.singleton.on("FileUploaded" as UsersInterface.SocketTokens.ClientInstructionType, this.onFilesUploaded.bind(this));
        modepress.EventManager.singleton.on("FileRemoved" as UsersInterface.SocketTokens.ClientInstructionType, this.onFilesRemoved.bind(this));
    }
